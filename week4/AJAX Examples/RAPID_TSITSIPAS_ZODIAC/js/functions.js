...
function rapidFacts(month,day){
	const data = null;
	document.getElementById("rapid").innerHTML="<h2> Info about your Date of Birth</h2>";
		...
		xhr.open('GET', 'https://numbersapi.p.rapidapi.com/'+month+'/'+day+'/date?fragment=true&json=true');
